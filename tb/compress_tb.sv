...
module compress_tb;
    ...
    initial begin
        ...
        $display("==================================================");
        $display("Starting ML-KEM Compress Module Exhaustive Testing");
        $display("==================================================");

        // Sweep all valid 'd' parameters
        for (int d_idx = 0; d_idx < 5; d_idx++) begin
            d_i = d_values[d_idx];
            $display("Testing d = %0d...", d_i);
            ...
            for (int x = 0; x < 3329; x += 4) begin
                ...
                for (int lane = 0; lane < 4; lane++) begin
                    if ((x + lane) < 3329) begin
                        ...
                        // Pad out-of-bounds lanes with 0 (e.g., x=3329, 3330, 3331)
                        coeff_i[lane]      = 0;
                ...
                // Halt immediately if there are too many errors to avoid console flood
        ...
        if (error_count == 0) begin
            ...
            $display("The combinational approximation is bit-exact to FIPS 203.");
        end else begin
